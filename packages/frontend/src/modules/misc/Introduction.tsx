    ...
    <Well>
      <p
        style={{
          ...
          fontSize: "1.5em",
          color: "orange",
          borderLeft: "0.2em solid orange",
          maxWidth: "50%",
        }}
      >
        I no longer have fun working on this project, and I don't see myself
        supporting it any longer. Importing and exporting to/from JSON should
        continue to work, but the telegram bot has been disabled.
      </p>
      <p>
